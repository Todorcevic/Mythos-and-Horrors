...
namespace MythosAndHorrors.PlayMode.Tests
{
    public class Card01603Tests : TestBase
    {
        ...
        public IEnumerator BlankCratureBuffTest()
        {
            ...
            gameActionTask = _gameActionsProvider.Create(new DefeatCardGameAction(creature, _investigatorsProvider.First.InvestigatorCard));
        ...
        public IEnumerator BlankCratureStarTokenBuffTest()
        {
            ...
            gameActionTask = _gameActionsProvider.Create(new PlayInvestigatorGameAction(_investigatorsProvider.Third));
            if (!DEBUG_MODE) yield return WaitToClick(_preparationScene.SceneCORE1.Study);
            if (!DEBUG_MODE) yield return WaitToMainButtonClick();
