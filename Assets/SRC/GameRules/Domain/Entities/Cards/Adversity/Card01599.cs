...
namespace MythosAndHorrors.GameRules
{
    public class Card01599 : CardAdversity
    {
        ...
        private void Init()
        {
            ...
            CreateActivation(2, DiscardLogic, DiscardCondition, PlayActionType.Activate, new Localization("Activation_Card01599"));
        }
        ...
        {
            await _gameActionsProvider.Create<HarmToInvestigatorGameAction>().SetWith(InvestigatorAffected, this, amountDamage: 1, isInevitable: true).Execute();
        }
