...
namespace MythosAndHorrors.GameRules
{
    public class Card01535 : CardSupply
    {
        ...
        {
            InteractableGameAction interactableGameAction = new(canBackToThisInteractable: false, mustShowInCenter: true, "Health", activeInvestigator);
            ...
            {
                interactableGameAction.CreateEffect(investigatorToSelect.AvatarCard, HealthInvestigator, PlayActionType.Choose, activeInvestigator);
