...
namespace MythosAndHorrors.GameRules
{
    public class Card01109 : CardGoal
    {
        ...
        private void Init()
        {
            CreateRealReaction<RoundGameAction>(PayHintsCondition, PayHintsLogic, GameActionTime.Before);
        }
        ...
        private async Task PayHintsLogic(RoundGameAction roundGameAction)
        {
            ...
            await _gameActionsProvider.Create(new PayHintsToGoalGameAction(this, specificInvestigators, _investigatorsProvider.Leader));
        }
