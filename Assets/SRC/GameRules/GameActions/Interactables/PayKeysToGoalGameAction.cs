...
namespace MythosAndHorrors.GameRules
{
    public class PayKeysToGoalGameAction : InteractableGameAction
    {
        ...
        public override bool CanBeExecuted => InvestigatorsToPay.Any(investigator => investigator.IsInPlay.IsTrue) && CardGoal.IsInPlay.IsTrue && !CardGoal.Revealed.IsActive && CardGoal.Keys.Value > 0;
