...
namespace MythsAndHorrors.PlayMode.Tests
{
    ...
    public class ResourceGameActionTests : TestBase
    {
        ...
        public IEnumerator Move_Resource_From_Card()
        {
            ...
            yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Leader, cardSupply.Cost, 2)).AsCoroutine();
        ...
        public IEnumerator Move_Resource_To_Card()
        {
            ...
            yield return _gameActionFactory.Create(new MoveCardsGameAction(cardSupply, _investigatorsProvider.Leader.AidZone)).AsCoroutine();
            yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Leader, cardSupply.Cost, 5)).AsCoroutine();
            yield return _gameActionFactory.Create(new PayResourceGameAction(_investigatorsProvider.Leader, cardSupply.Cost, 5)).AsCoroutine();
        ...
        public IEnumerator Move_Resource_To_Investigator()
        {
            ...
            do
            {
                yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Leader, _chaptersProvider.CurrentScene.Info.CardScene.PileAmount, 5)).AsCoroutine();
        ...
        public IEnumerator Move_Resource_To_Pile()
        {
            ...
            {
                yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Leader, _chaptersProvider.CurrentScene.Info.CardScene.PileAmount, 5)).AsCoroutine();
                yield return _gameActionFactory.Create(new PayResourceGameAction(_investigatorsProvider.Leader, _chaptersProvider.CurrentScene.Info.CardScene.PileAmount, 5)).AsCoroutine();
        ...
        public IEnumerator Move_Resource_Swaping()
        {
            ...
            yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Leader, _chaptersProvider.CurrentScene.Info.CardScene.PileAmount, 5)).AsCoroutine();
            yield return _gameActionFactory.Create(new GainResourceGameAction(_investigatorsProvider.Second, _chaptersProvider.CurrentScene.Info.CardScene.PileAmount, 5)).AsCoroutine();
