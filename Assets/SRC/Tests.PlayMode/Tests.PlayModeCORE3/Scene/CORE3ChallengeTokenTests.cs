...
namespace MythosAndHorrors.PlayModeCORE3.Tests
{
    public class CORE3ChallengeTokenTests : TestCORE3Preparation
    {
        ...
        public IEnumerator NormalCreatureTokenTest()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(monster, SceneCORE3.Forest2.OwnZone).Execute().AsCoroutine();
        ...
        public IEnumerator NormalCultistTokenTest()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(monster, SceneCORE3.Forest2.OwnZone).Execute().AsCoroutine();
            yield return _gameActionsProvider.Create<IncrementStatGameAction>().SetWith(monster.Eldritch, 3).Execute().AsCoroutine();
        ...
        public IEnumerator NormalDangerTokenTest()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(monster, investigator.CurrentPlace.OwnZone).Execute().AsCoroutine();
        ...
        public IEnumerator NormalAncientTokenTest()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(ancient, SceneCORE3.Forest2.OwnZone).Execute().AsCoroutine();
