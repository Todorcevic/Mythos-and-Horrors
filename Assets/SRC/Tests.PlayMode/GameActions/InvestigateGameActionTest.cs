...
namespace MythosAndHorrors.PlayMode.Tests
{
    public class InvestigateGameActionTest : TestBase
    {
        ...
        public IEnumerator InvestigateTest()
        {
            ...
            yield return _gameActionFactory.Create(new InvestigatorMoveToPlaceGameAction(_investigatorsProvider.Leader, place)).AsCoroutine();
        ...
        public IEnumerator RealInvestigateTest()
        {
            ...
            if (DEBUG_MODE) yield return new WaitForSeconds(230);
            Assert.That(_investigatorsProvider.Leader.Turns.Value, Is.EqualTo(GameValues.DEFAULT_TURNS_AMOUNT - place.InvestigationTurnsCost.Value));
            Assert.That(_investigatorsProvider.Leader.Hints.Value, Is.EqualTo(1));
        }
    }
}
