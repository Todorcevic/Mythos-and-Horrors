...
namespace MythosAndHorrors.PlayModeCORE1.Tests
{
    public class GameActionCreatureMoveTests : TestCORE1Preparation
    {
        ...
        public IEnumerator MoveCratureTest()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCreatureGameAction>().SetWith((IStalker)creature, _investigatorsProvider.AllInvestigatorsInPlay).Start().AsCoroutine();
