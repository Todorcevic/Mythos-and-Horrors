...
namespace MythosAndHorrors.PlayMode.Tests
{
    public class Card01109Tests : TestBase
    {
        ...
        public IEnumerator PayHintTest()
        {
            ...
            yield return _gameActionsProvider.Create(new GainHintGameAction(_investigatorsProvider.Leader, _preparationScene.SceneCORE1.Hallway.Hints, cardGoal.Hints.Value)).AsCoroutine();
