...
namespace MythsAndHorrors.PlayMode.Tests
{
    ...
    {
        public override string JSON_CARDINFO_PATH => "Assets/Data/Tests/CardsInfo.json";
        public override string JSON_CARDEXTRAINFO_PATH => "Assets/Data/Tests/CardsExtraInfo.json";
        public override string JSON_INVESTIGATORS_PATH => "Assets/Data/Tests/Investigators.json";
        public override string JSON_SAVE_DATA_PATH => "Assets/Data/Tests/Save/SaveData.json";
