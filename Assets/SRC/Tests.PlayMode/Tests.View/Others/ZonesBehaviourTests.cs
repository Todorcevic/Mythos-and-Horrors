...
namespace MythosAndHorrors.PlayModeView.Tests
{
    ...
    public class ZonesBehaviourTests : PlayModeTestsBase
    {
        ...
        public IEnumerator Move_Card_In_Two_Zones()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Card, _chaptersProvider.CurrentScene.GetPlaceZone(0, 2)).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut2.Card, _chaptersProvider.CurrentScene.GetPlaceZone(0, 3)).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Basic()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Card, _investigatorsProvider.First.InvestigatorZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Out()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Card, _chaptersProvider.CurrentScene.OutZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Row()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), _investigatorsProvider.First.AidZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Row_Creating_Holders()
        {
            ...
            foreach (CardView cardView in sut)
                yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(cardView.Card, _investigatorsProvider.First.AidZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Hand()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), _investigatorsProvider.First.HandZone).Start().AsCoroutine();
        ...
        public IEnumerator Remove_Card_In_Zone_Hand()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), _investigatorsProvider.First.HandZone).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.First().Card, _chaptersProvider.CurrentScene.OutZone).Start().AsCoroutine();
        ...
        public IEnumerator Remove_Card_In_Zone_Deck()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), _investigatorsProvider.First.DeckZone).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Last().Card, _chaptersProvider.CurrentScene.OutZone).Start().AsCoroutine();
        ...
        public IEnumerator Remove_Card_In_Zone_Discard()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), _investigatorsProvider.First.DiscardZone).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Last().Card, _chaptersProvider.CurrentScene.OutZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Card()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut2.Card, _investigatorsProvider.First.AidZone).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card), sut2.Card.OwnZone).Start().AsCoroutine();
        ...
        public IEnumerator Remove_Card_In_Zone_Card()
        {
            ...
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut2.Card, _chaptersProvider.CurrentScene.GetPlaceZone(0, 2)).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Select(cardView => cardView.Card).ToList(), sut2.Card.OwnZone).Start().AsCoroutine();
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.First().Card, _chaptersProvider.CurrentScene.OutZone).Start().AsCoroutine();
        ...
        public IEnumerator Move_Card_In_Zone_Out_And_Back()
        {
            ...
            Assert.That(sut.gameObject.activeSelf, Is.EqualTo(false));
            yield return _gameActionsProvider.Create<MoveCardsGameAction>().SetWith(sut.Card, _investigatorsProvider.First.HandZone).Start().AsCoroutine();
